...
class UsersController extends Controller
{
    ...
    public function index()
    {
        ...
        $users = User::with(['roles', 'branch', 'media'])->get();

        $roles = Role::get();

        $branches = Branch::get();

        return view('frontend.users.index', compact('branches', 'roles', 'users'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.users.create', compact('branches', 'roles'));
    }
    ...
    public function edit(User $user)
    {
        ...
        return view('frontend.users.edit', compact('branches', 'roles', 'user'));
    }
    ...
    public function show(User $user)
    {
        ...
        $user->load('roles', 'branch', 'employeeAppointments', 'userUserAlerts');
