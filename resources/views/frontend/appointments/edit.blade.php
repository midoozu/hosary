        ...
        <div class="card-body">
            <form method="POST" action="{{ route("frontend.appointments.update", [$appointment->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control datetime {{ $errors->has('date') ? 'is-invalid' : '' }}" type="text" name="date" id="date" value="{{ old('date', $appointment->date) }}" required>
                    @if($errors->has('date'))
                ...
                <div class="form-group">
                    <div class="form-check {{ $errors->has('check_out') ? 'is-invalid' : '' }}">
                        ...
                        <input class="form-check-input" type="checkbox" name="check_out" id="check_out" value="1" {{ $appointment->check_out || old('check_out', 0) === 1 ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('pulse_counter') ? 'is-invalid' : '' }}" type="number" name="pulse_counter" id="pulse_counter" value="{{ old('pulse_counter', $appointment->pulse_counter) }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('used_pulse') ? 'is-invalid' : '' }}" type="number" name="used_pulse" id="used_pulse" value="{{ old('used_pulse', $appointment->used_pulse) }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('device_pulse') ? 'is-invalid' : '' }}" type="number" name="device_pulse" id="device_pulse" value="{{ old('device_pulse', $appointment->device_pulse) }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('other_service') ? 'is-invalid' : '' }}" type="number" name="other_service" id="other_service" value="{{ old('other_service', $appointment->other_service) }}" step="0.01">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('total_price') ? 'is-invalid' : '' }}" type="number" name="total_price" id="total_price" value="{{ old('total_price', $appointment->total_price) }}" step="0.01">
