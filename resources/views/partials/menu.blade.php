    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @endcan
                @can('setting_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/clinics*") ? "menu-open" : "" }} {{ request()->is("admin/doctors*") ? "menu-open" : "" }} {{ request()->is("admin/companies*") ? "menu-open" : "" }} {{ request()->is("admin/services*") ? "menu-open" : "" }} {{ request()->is("admin/branches*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
