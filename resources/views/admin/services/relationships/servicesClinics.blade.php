    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-servicesClinics">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($clinics as $key => $clinic)
                            <tr data-entry-id="{{ $clinic->id }}">
                                ...
                                <td>
                                    @foreach($clinic->services as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-servicesClinics:not(.ajaxTable)').DataTable({ buttons: dtButtons })
